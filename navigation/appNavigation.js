...
import {HomeIcon as HomeOutline, HeartIcon as HeartOutline, BellIcon as BellOutline } from 'react-native-heroicons/outline';
import {HomeIcon as HomeSolid, HeartIcon as HeartSolid, BellIcon as BellSolid} from 'react-native-heroicons/solid';
...
const menuIcons = (route, focused)=> {
  ...
  if (route.name === 'home') {
    ...
    icon =  focused? <BellIcon size="30" color={themeColors.bgLight} /> : <BellOutline size="30" strokeWidth={2} color="white" />
  }
